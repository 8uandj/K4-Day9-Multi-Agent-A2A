...
RUNTIME = "Ollama on Apple M4 Pro 24GB / macOS"
...
MODEL_REGISTRY: tuple[ModelSpec, ...] = (
    ModelSpec("A0_coordinator", "qwen3:8b", 8.2, thinking=True),
    ModelSpec("A1_order_product", "qwen3:8b", 8.2),
    ModelSpec("A2_customer", "qwen3:4b-instruct", 4.0),
    ModelSpec("A3_payment", "qwen3:8b", 8.2),
    ModelSpec("A4_delivery", "qwen3:8b", 8.2),
    ModelSpec("A5_policy", "qwen3:8b", 8.2, thinking=True),
    ModelSpec("A6_evidence", "qwen3:4b-instruct", 4.0),
    ModelSpec("A7_verifier", "llama3.1:8b", 8.0),
)
